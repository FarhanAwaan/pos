                                    ...
                                    <div class="box-body" id="printshow">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="pull-right m-t-20">
                                                    <p class="m-t-10"><strong>Order ID: </strong> <as id="cnmbr"><?php echo $_POST['invoice_no']; ?></as></p>
                                                    <p><strong>Vendor Name:</strong>
                                                    <?php echo $_POST['vendor_name'];?> 
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table m-t-30" id="invoicet">
                                                        ...
                                                        if(isset($_POST['viewinvoice']))
                                                        {
                                                            ...
                                                            $sql="select bi.*,i.name as iname,b.name AS bname,c.name AS cname from buy_items bi,items i,bike b,company c where bi.item_id=i.id AND i.bike_id=b.id AND i.company_id=c.id AND invoice_no='$invoice_no'";
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <hr>
                                                <h4 class="text-right">Rs <?php echo $sum; ?></h4>
                                            </div>
                                        </div>
                                        <hr>
