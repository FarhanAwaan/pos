			                ...
			                <form role="form" action="function.php" method="POST">
								<div class="box-body">
									...
									<div class="form-group">
										...
										<input type="number" class="form-control" name="amount" id="exampleInputPassword1" required placeholder=" Amount">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1"> Date</label>
										<input type="date" class="form-control" name="date" id="exampleInputPassword1" required placeholder=" Date">
									</div>
								</div>
								<div class="box-footer">
									<button type="submit" name="add_expenditure" class="btn btn-primary btn-block">Submit</button>
								</div>
		                	</form>
						</div>
						<!-- /.box -->
