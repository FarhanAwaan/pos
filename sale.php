...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
								...
								<div class="box-body">
								    <div class="row">
								        ...
								        <div class="col-sm-6">
        									...
        									<div class="form-group">
            									<label for="rnwpricelabel">Retail Price</label>
			                ...
			                <form role="form" action="function.php" method="POST">
								<div class="box-body">
								    <div class="row">
								        <div class="col-sm-6">
    								        <div class="form-group">
    									        <label for="exampleInputPassword1">Customer Type<small></small></label><br>
        									    &nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" onchange="customer()" checked class="minimal" id="r1" value="1" name="type"> Retail </label>
        									    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        									    <label><input type="radio" id="r2" value="2" onchange="customer()" name="type"> Wholesale</label>
        									 </div>
            								<!--<div class="form-group">-->
            								<!--	<label for="exampleInputPassword1">Total Amount<small></small></label>-->
            								<!--	<input type="number" class="form-control" name="tprice" readonly id="tprice" placeholder="Total Amount">-->
								        ...
								        <div class="col-sm-6">
                                          <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control col-sm-6 .input-lg" onkeyup="ch_name2()" id="cus_name2" name="pname" placeholder=" Customer Name">
                                                        <select class="form-control select2 col-sm-6" onchange="ch_name1()" id="cus_name1" >
                                                          <option value="0" hidden selected="selected"> -- Customer Name -- </option>
                                                            <?php 
    								...
    								<div class="box-footer">
    									<button type="button" name="add_item" onclick="disablee()" id="userinfo" class="btn btn-primary btn-block">Submit</button>
    								</div>
								</div>
                                    ...
                                    <div class="box-body" id="printshow">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="pull-right m-t-20">
                                                    <p class="m-t-10"><strong>Order ID: </strong> <as id="cnmbr">S<?php echo date('YmdHis'); ?></as></p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p class="text-right">Total: <as id="totlam1"></as></p>
                                                <hr>
  ...
  $('[data-toggle="tooltip"]').tooltip()
	...
	var cusname,cusid,custype="retail",cusstatus=false;
...
// 	trprice=document.getElementById("rprice") ,
                			...
                			if(table2.rows.length > 1)
                			{
                    			for(var i=1;i<=table2.rows.length;i++)
                    			{
                    			 //   alert((9+)+"  ");
                				    ...
                				    document.getElementById("totlam2").innerHTML = (finalpriceee-disc);
                    			}
                			}
                			else
                			{
	    ...
	    function approve()
        {
            ...
            else
            {
                ...
                qry=document.getElementById("cnmbr").innerHTML+"|"+cusid+"|"+cusname+"|"+custype;
                var j=0,i;
		...
		function customer()
		{
		    if (document.getElementById('r1').checked) {
                  ...
                  $('#cus_name2').show();
                  cusid = 0;
                cusname = document.getElementById("cus_name2").value;
    		    custype="retail";
                $("#rprice").attr("placeholder","Retail Price Per Product");
                $("#rprice").attr("name","rprice");
                $("label[for='rnwpricelabel']").text("Retail Price");
                }
            if (document.getElementById('r2').checked) {
                  $('#cus_name2').hide();
                  $('.select2').show();
                  var customer=document.getElementById("cus_name1");
                cusid = customer.options[customer.selectedIndex].value;
                cusname = customer.options[customer.selectedIndex].text;
    		    custype="wholesale";
                $("#rprice").attr("placeholder","Wholesale Price Per Product");
                $("#rprice").attr("name","wprice");
                $("label[for='rnwpricelabel']").text("Wholesale Price");
                }
		...
		function disablee()
    	{
    	    ...
    	    {
    	        document.getElementById("cus_name1").disabled=true;
    	        document.getElementById("cus_name2").disabled=true;
