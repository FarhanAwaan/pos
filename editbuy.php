			                ...
			                <form role="form" action="function.php" method="POST">
								...
								<div class="box-body">
    								...
    								<div class="form-group">
    									...
    									<input type="number" class="form-control" name="nqty" value="<?php echo $nstock ;?>" required id="wire_used" placeholder="Quantaty">
    								</div>
    								<div class="form-group">
    								...
    								<div class="box-footer">
    									<button type="submit" name="update_buy" class="btn btn-primary btn-block">Submit</button>
    								</div>
								</div>
