                                            ...
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table m-t-30" id="invoicet">
                                                        ...
                                                        <tbody>
                                                        <?php 
                                                            $sql="select ls.*,i.name as iname,b.name AS bname,c.name AS cname from labour_sell ls,items i,bike b,company c where ls.item_id=i.id AND i.bike_id=b.id AND i.company_id=c.id AND invoice_no='$invoice_no'";
