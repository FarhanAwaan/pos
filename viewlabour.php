										...
										<tr>
                                            ...
                                            <?php if ($_SESSION['role'] == 'admin') { ?>
                                                ...
                                                <div style="display: inline-flex;" role="group">
                                                    <form action="editlabour.php" method="POST">
                                                        <input type="hidden" name="action_id" value="<?php echo $id;?>">
                                                        <button type="submit" name="edit_labour"  data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-secondary"><i class="fas fa-edit"></i></button>
                                                    </form>
