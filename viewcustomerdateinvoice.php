...
<body class="hold-transition skin-blue sidebar-mini">
								    ...
								    <div class="row">
								        <div class="col-sm-4">
								            <div class="form-group">
        										...
        										<input type="text" class="form-control" value="<?php echo $_POST['pamount'];?>" name="pamount" id="pamount" readonly placeholder=" Pending Amount">
        									</div>
								        </div>
								        <div class="col-sm-4">
								            <div class="form-group">
        										<label for="exampleInputPassword1"> Recieved Amount</label>
        										<input type="text" class="form-control" onkeyup="amount()" name="gamount" id="gamount" required placeholder=" Recieved Amount">
        									</div>
								        </div>
								        <div class="col-sm-4">
								            <div class="form-group">
        										<label for="exampleInputPassword1"> Remaining Amount</label>
        										<input type="text" class="form-control" name="ramount" id="ramount" readonly placeholder=" Remaining Amount">
        									</div>
								        </div>
								    </div>
    								<div class="box-footer">
    									<button type="submit" name="pay_bill" id="addto" class="btn btn-primary btn-block">Submit</button>
    								</div>
								</div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table m-t-30" id="invoicet">
                                                        ...
                                                        <tbody>
                                                        <?php 
                                                            $sql="select vs.*,i.name as iname,b.name AS bname,c.name AS cname from vendor_sell vs,items i,bike b,company c where vs.date='$date' AND vs.customer_id='$id' AND vs.item_id=i.id AND i.bike_id=b.id AND i.company_id=c.id";
	...
	<script>
		...
		function amount()
		{
		    var v1=document.getElementById("pamount").value;
		    var v2=document.getElementById("gamount").value;
		    document.getElementById("ramount").value=val(v1)-val(v2);
		}
	</script>
